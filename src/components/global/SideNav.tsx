...
import { AreaChart, Cog, FileCode2, Home, ListTodo, MessageSquare } from "lucide-react";
...
export default function SideNav({ projectId }: { projectId: string }) {
  ...
  return (
    <nav className="flex flex-col h-auto w-1/5 pt-6 pb-6 items-center px-2 md:px-4 gap-4 border-r border-slate-400 ">
      <Link
        className={clsx(
